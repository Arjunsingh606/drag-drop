            ...
            checkedImages.map(async (image) => {
                if (image === item.id) {
                    try {
                        ...
                        const updatedImages = images.filter((item: any) => !checkedImages.includes(item.id));
                        setImages(updatedImages);
                        setCheckedImages([]);
                    } catch (error) {
            ...
            <Row className="gallary">
                <Col className="image-gallary">
                    ...
                    <div className="gallary-items">
                        <Button variant="primary" className="delete-icon" onClick={handleDeleteCheckedImages}>
                            <FontAwesomeIcon icon={faTrash} />
                        </Button>

                        <Nav variant="pills" className="list-details-btn">
                            <Nav.Item>
                                <Nav.Link eventKey="first" className="tabs-btn"><FontAwesomeIcon icon={faList} /></Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link eventKey="second" className="tabs-btn"><FontAwesomeIcon icon={faTableCellsLarge} /></Nav.Link>
                            </Nav.Item>
                        </Nav>
                        <div>
                            ...
                            <AddImage show={show} handleClose={handleClose} getData={getData} />
                        </div>
                    </div>
                </Col>
